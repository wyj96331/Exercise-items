            ...
            <div class="chooseArea">
              ...
              <dl v-for="spuSaleAttr in spuSaleAttrList" :key="spuSaleAttr.id">
                ...
                <dd
                  ...
                  :key="spuSale.id"
                  @click="
                    changeActive(spuSale, spuSaleAttr.spuSaleAttrValueList)
                  "
                >
...
export default {
  ...
  mounted () {
    this.$store.dispatch('reqGoodsInfoAction', this.$route.params.skuid)
  },
  computed: {
    ...mapGetters(['categoryView', 'skuInfo', 'spuSaleAttrList']),
    // 给子组件的数据
    skuImageList () {
      //  如果服务器的数据没有回来，sknInfo对象是空对象
      return this.skuInfo.skuImageList || []
    }
  },
  methods: {
    // 排他思想实现点击获取高亮
    changeActive (spuSale, array) {
      array.forEach(item => {
        item.isChecked = 0
      })
      spuSale.isChecked = 1
